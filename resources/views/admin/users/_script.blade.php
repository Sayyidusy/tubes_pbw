  ...
  $(document).on('click', '.btn-edit', function(e) {
    ...
    $.ajax({
        ...
        success: function(response) {
          ...
          // $('#editUserModal #jenisKelamin').val(response.user.jenisKelamin);
          $('#editUserModal #nohp').val(response.user.nohp);
          $('#editUserModal #alamat').val(response.user.alamat);
          $('#editUserModal #kodepos').val(response.user.kodepos);
