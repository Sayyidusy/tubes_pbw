        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              @endif
              <h6 class="font-weight-light">Masuk Sebagai Admin EZPC.</h6>
              <form class="pt-3" method="POST" action="{{ url('admin/login') }}"> 
                ...
                <div class="mt-3">
                  <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="">MASUK</button>
                </div>
